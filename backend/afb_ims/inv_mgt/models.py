...
class PurchaseItem(models.Model):
    ...
    purchaseBill_id = models.ForeignKey(PurchaseBill, on_delete=models.PROTECT, blank=True, null=True)
...
class SalesItem(models.Model):
    billno = models.ForeignKey(SalesBill, on_delete=models.PROTECT, related_name="sales_items", blank=True, null=True)
